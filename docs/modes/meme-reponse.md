...
| TV | Résultats | La question en haut, avec à côté le verdict en gros : le ou les libellés en tête (« Fraise ! »), « Tout le monde d'accord ! », « Chacun sa réponse » ou « Personne n'a répondu ». Les groupes de 2 et plus en grandes cartes, du plus grand au plus petit : libellé en gros, pastilles à initiale des joueurs (5 au plus, sinon 4 et « +N » ; les pseudos sont dans le classement), « +600 ». Le ou les groupes en tête mis en avant (« Réponse la plus donnée »). Dessous, une ligne plus discrète « En solo : » avec chaque réponse isolée (pastille à initiale, texte). Puis « Pas de réponse : » avec les pastilles à initiale. Classement général à droite, avec les points gagnés |
